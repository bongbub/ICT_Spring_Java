...
public class UserDTO_2 {
	...
	private List<BoardDTO_2> boardDTO;			// => mvc_board_tbl 내포, - user_id 가 FK

	public UserDTO_2(int userId, String userName, Date regDate, List<BoardDTO_2> boardDTO) {
		super();
		this.userId = userId;
	...
	public List<BoardDTO_2> getBoardDTO() {
		return boardDTO;
	}
	public void setBoardDTO(List<BoardDTO_2> boardDTO) {
		this.boardDTO = boardDTO;
	}
