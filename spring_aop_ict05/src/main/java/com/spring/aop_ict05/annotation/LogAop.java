...
@Aspect			// <aop:aspect id="logger" ref="log">	<!-- 관점 설정 -->
public class LogAop {
	
	
	@Pointcut("execution(* com.spring.aop_ict05.annotation.*.*(..))")
	public void allPointCut() {}	// 형식적인 메서드 <aop:pointcut id="allPointCut" expression="execution(* com.spring.aop_ict05.annotation.*.*(..))"/>
	
	@Around("allPointCut()")
	public void loggerAop(ProceedingJoinPoint joinPoint) {	// <aop:around method="loggerAop" pointcut-ref="allPointCut"/>
