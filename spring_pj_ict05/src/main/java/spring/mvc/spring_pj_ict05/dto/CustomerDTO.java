...
public class CustomerDTO {
	...
	private Date user_birthday;			// Date 임포트 시, java.util이 아닌 java.sql 사용 --> DB랑 연결해서 사용할 것이기 때문!
	private String user_address;
	private String user_hp;
	private String user_email;
	private Timestamp user_regdate;		// Timestamp 임포트 시, java.sql.Timestamp로 가져와야함 주의!
