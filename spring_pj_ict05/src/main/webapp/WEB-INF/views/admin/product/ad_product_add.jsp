								...
								<table>
									<tr>
										...
										<td>
											<input type="text" class="input" name="pdBrand"
												id="pdBrand" size="50" placeholder="50자 이내로 작성" required autofocus>
										</td>
									</tr>
									<tr>
										<th> * 상품명 </th>
										<td >
											<input type="text" class="input" name="pdName" id="pdName"			
												size="50" placeholder="50자 이내로 작성" required>
										</td>
									</tr>
									<tr>
										<th> * 상품 이미지 </th>
									...
									<tr>
										...
										<td >
											<select class="input" name="pdCategory" required>
												...
												<option value="모바일/전자기기">모바일/전자기기</option>
											</select>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td >
											<input type="number" class="input" name="pdPrice" id="pdPrice"			
												size="10" placeholder="가격 작성" required>
										</td>
									</tr>
									<tr>
										<th> * 상품수량 </th>
										<td >
											<input type="number" class="input" name="pdQuantity" id="pdQuantity"			
												size="10" placeholder="수량 작성" required>
										</td>
									</tr>
									<tr>
										<th> * 상품 상태코드 </th>
									...
									<tr>
										<td colspan="4">
											...
											<input type="button" class="inputButton" value="작성취소">
